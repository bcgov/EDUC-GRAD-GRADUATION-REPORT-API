...
public class StudentNonGradReportImpl extends ReportImpl implements GraduationReport {

    private List<Student> students;
    private School school;

    public StudentNonGradReportImpl() {
        this("StudentNonGrad");
    }
     ...
     */
    public StudentNonGradReportImpl(String name) {
        super(name);
    }
