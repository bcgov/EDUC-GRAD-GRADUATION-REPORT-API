...
public interface GradStudentCertificatesRepository extends JpaRepository<GradStudentCertificatesEntity, UUID> {
	...
	@Query(value="update STUDENT_CERTIFICATE set DISTRIBUTION_DATE=sysdate WHERE GRADUATION_STUDENT_RECORD_ID=:studentID and CERTIFICATE_TYPE_CODE=:credentialTypeCode",nativeQuery = true)
