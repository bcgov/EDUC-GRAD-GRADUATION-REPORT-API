...
public class EducGraduationApiUtils {
	...
	public static String formatDate(Date date) {
		...
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(ReportApiConstants.DEFAULT_DATE_FORMAT);
	...
	public static String formatDateForReport(String updatedTimestamp) {
		SimpleDateFormat fromUser = new SimpleDateFormat(ReportApiConstants.DEFAULT_DATE_FORMAT);
	...
	public static String formatDateForReportJasper(String updatedTimestamp) {
		SimpleDateFormat fromUser = new SimpleDateFormat(ReportApiConstants.DEFAULT_DATE_FORMAT);
		SimpleDateFormat myFormat = new SimpleDateFormat(ReportApiConstants.DEFAULT_DATE_FORMAT);
		try {
			return myFormat.format(fromUser.parse(updatedTimestamp));
		} catch (ParseException e) {
			log.debug(ERROR_MSG,e.getLocalizedMessage());
	...
	public static Date formatIssueDateForReportJasper(String updatedTimestamp) {
		...
		SimpleDateFormat myFormat = new SimpleDateFormat(ReportApiConstants.DEFAULT_DATE_FORMAT);
		try {
			return new SimpleDateFormat(ReportApiConstants.DEFAULT_DATE_FORMAT).parse(myFormat.format(fromUser.parse(updatedTimestamp)));
		} catch (ParseException e) {
			log.debug(ERROR_MSG,e.getLocalizedMessage());
		}
		return null;
	...
	public static String parsingDateForCertificate(String sessionDate) {
		...
		Date temp = toLastDayOfMonth(parseDate(actualSessionDate, ReportApiConstants.SECONDARY_DATE_FORMAT));
		return formatDate(temp, ReportApiConstants.DEFAULT_DATE_FORMAT);
	}
	...
	public static Date parsingTraxDate(String sessionDate) {
		...
		Date temp = EducGraduationApiUtils.parseDate(actualSessionDate, ReportApiConstants.SECONDARY_DATE_FORMAT);
		String sDates = EducGraduationApiUtils.formatDate(temp, ReportApiConstants.DEFAULT_DATE_FORMAT);
		return toLastDayOfMonth(EducGraduationApiUtils.parseDate(sDates, ReportApiConstants.DEFAULT_DATE_FORMAT));
	}
	...
	public static String parsingNFormating(String inDate) {
		...
		Date temp = toLastDayOfMonth(EducGraduationApiUtils.parseDate(actualDate, ReportApiConstants.SECONDARY_DATE_FORMAT));
		return EducGraduationApiUtils.formatDate(temp, ReportApiConstants.DEFAULT_DATE_FORMAT);
	}
	...
	public static String getSimpleDateFormat(Date date) {
		...
		SimpleDateFormat formatter = new SimpleDateFormat(ReportApiConstants.DEFAULT_DATE_FORMAT);
